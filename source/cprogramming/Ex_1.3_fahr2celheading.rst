...
In this program we are going to convert a given Fahrenheit table to Celsius table using the formula C=(5/9)(F-32)
...
The variable lower is assigned the attribute 0 similarly upper to 300, step to 20, and fahr to lower.
