...
/**
 * Example 141 - Input-Output: Twelve Examples in One
 */
class InputOutputExamples {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        // Write numbers and words on file "f.txt" in a human-readable form
        ...
        // Writing an object or array to binary file "o.dat"
        ...
        // Read from a String s as if were a text file:
        ...
        System.out.println("Type one character and press Enter: ");
