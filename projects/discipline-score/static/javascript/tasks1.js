...
(function () {
    ...
    i.prototype.q = function () {
        ...
        var b = Math.floor((this.e.offsetWidth - this.fa) / 2),
            e = Math.floor((this.e.offsetHeight - this.$) / 2) + a;
    ...
    function x(a, b, e) {
        var c = a.className.split(" "),
            d = [];
        for (var g = 0; g < c.length; g++) if (c[g] != b) d.push(c[g]);
        if (e) d.push(b);
        a.className = d.join(" ")
    };
    ...
    z.prototype.P = function (a) {
        ...
        var b = this.a;
        if (b.parentNode.style.position != "absolute") b.parentNode.style.position = "relative";
    ...
    z.prototype.Q = function (a) {
        ...
        var c = this.a,
            ...
            g = c.offsetTop + e;
        if (this.Z) {
            var h = c.parentNode.offsetWidth - c.offsetWidth,
                l = c.parentNode.offsetHeight - c.offsetHeight;
    ...
    j.prototype.y = function (a, b) {
        ...
        if (!c) return;
        var d = [];
        for (var g = 2; g < arguments.length; g++) d.push(arguments[g]);
        for (var g = 0; g < c.length; g++) c[g].apply(a, d)
    };
    ...
    function C(a, b, e) {
        ...
        if (g == "POST") {
            ...
            d.setRequestHeader("Content-Type", h)
        }
    ...
    function B(a, b) {
        for (var e = 0; e < a.length; e++) if (a[e] == b) {
            a.splice(e, 1);
            return true
        }
        return false
    ...
    E.prototype.attach = function (a) {
        ...
        var e = this.b("table", b),
            c = this.b("tbody", e),
            d = this.b("tr", c),
            g = this.b("td", d, "checkbox"),
            h;
        try {
    ...
    F.prototype.w = function () {
        var a = [];
        for (var b = this.a.firstChild; b != null; b = b.nextSibling) if (b.task) a.push(b.task.key());
        var e = false;
        for (var c = 0; c < a.length; c++) if (a[c] != this.T[c]) {
            e = true;
            break
        }
        if (!e) return;
