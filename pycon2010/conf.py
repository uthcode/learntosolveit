# -*- coding: utf-8 -*-
#
# How to Solve it using Python documentation build configuration file, created by
...
project = u'How to Solve it using Python'
copyright = u'2010, Senthil Kumaran'
...
htmlhelp_basename = 'HowtoSolveitusingPythondoc'
